    ...
    function toStep(index) {
        ...
        .then((res) => {
            ...
            timer = setTimeout(() => {
                ...
                refModal.content = typeof content === 'string' ? <View><Text style={{color:"#000000",fontSize:15,lineHeight:20,marginLeft:8}} >{content}</Text></View> : content;
                //refModal.content = <View><Text style={{color:"red",fontSize:15}} >{content}</Text></View>
                refModal.forceUpdate(() => {
            ...
            <View style={[styles.container, {zIndex}]}>
                ...
                <Animated.View style={[styles.toolTip, this.tooltip, {opacity: this._aniOpacity}]}>
                    <View style={{justifyContent:"center",alignItems:"center",marginTop:12}} >
                        <Text style={{color:"#000000",width:50,fontWeight:"600",fontSize:16}} >{lang === "tr"?"İPUCU":"HINT"}</Text>
                    </View>
                    <View style={{height:0.5,backgroundColor:"#D8D8D8",marginTop:11}} />
                    ...
                    <View style={[styles.introBar]}>
                        <View style={[styles.introButton,{
                            ...
                            <Text style={[styles.buttonText, {
                                color: '#999'
                            }]}>{lang === "tr"?"Atla":"Skip"}</Text>
                        </View>
                        <View style={[styles.introButton]} onTouchStart={() => this.props.prev()}>
                            <Text style={[styles.buttonText]}>{lang === "tr"?"Önceki":"Preview"}</Text>
                        </View>
                        <View style={[styles.introButton, {marginLeft: 8}]} onTouchStart={() => this.props.next()}>
                            <Text style={[styles.buttonText]}>{lang === "tr"?"Sonraki":"Next"}</Text>
                        </View>
                    </View>
                </Animated.View>
            </View>
